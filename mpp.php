...
<div class="container">
  ...
  <div class="main" id="tourTabingContent">
    ...
    <div class="table tabing">
      <div class="title"><a href="#top" title="返回顶部" class="more">55</a><span>8</span>服务器实时数据</div>
      <table class="content">
        <tr>
          <td>实时开关</td>
        ...
        <tr>
          ...
          <td id="uptime"><?php echo $realtime['uptime']; ?></td>
        </tr>
        <tr>
          <td>网站目录空间</td>
    ...
    <div class="table tabing">
      ...
      <table class="content">
        <tr>
          ...
          <td width="18%"><?php echo (false !== preg_match('phpinfo', $dis_func)) ? '<span class="no">×</span>' : '<a href="'.$php_url.'?act=phpinfo" target="_blank">phpinfo()</a>'; ?></td>
